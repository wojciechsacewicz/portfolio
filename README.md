...
- Typography-led opening statement focused on product engineering and delivery discipline.
...
- `src/features/hero/` owns the typography-led opening narrative and proof strip.
