...
const technologyIconPaths: Record<(typeof technologies)[number]['slug'], string> = {
  ...
  openai: 'M12 2.25 14.55 8l6.2.65-4.65 4.15 1.3 6.1-5.4-3.1-5.4 3.1 1.3-6.1-4.65-4.15L9.45 8 12 2.25zm0 5.15-1.05 2.35-2.55.27 1.92 1.71-.54 2.5L12 12.96l2.22 1.27-.54-2.5 1.92-1.71-2.55-.27L12 7.4z',
  ...
  adobephotoshop: 'M2 2h20v20H2V2zm4.2 4.6v10.8h2.2v-3.5h1.7c2.55 0 4.1-1.4 4.1-3.72 0-2.25-1.48-3.58-3.98-3.58H6.2zm2.2 1.85h1.62c1.25 0 1.95.62 1.95 1.78 0 1.2-.7 1.82-1.98 1.82H8.4v-3.6zm8.4 1.05c-1.85 0-3.2 1.02-3.2 2.5 0 1.3.8 2.05 2.65 2.5 1.08.27 1.4.48 1.4.88 0 .45-.42.7-1.15.7-.95 0-1.85-.35-2.75-.98v1.88c.75.48 1.7.72 2.78.72 2 0 3.35-.98 3.35-2.52 0-1.32-.78-2.08-2.62-2.55-1.12-.28-1.45-.48-1.45-.85 0-.4.38-.65 1.02-.65.82 0 1.65.27 2.47.8v-1.8c-.72-.42-1.55-.62-2.5-.62z',
  adobepremierepro: 'M2 2h20v20H2V2zm4.1 4.6v10.8h2.2v-3.5H10c2.55 0 4.1-1.4 4.1-3.72 0-2.25-1.48-3.58-3.98-3.58H6.1zm2.2 1.85h1.62c1.25 0 1.95.62 1.95 1.78 0 1.2-.7 1.82-1.98 1.82H8.3v-3.6zm6.75 1.2v7.75h2.12v-3.72c0-1.45.78-2.18 2.33-2.18V9.45c-1.12-.05-1.92.48-2.42 1.58l-.13-1.38h-1.9z',
  slack: 'M9.5 2a2 2 0 0 1 2 2v5.5h-2A2 2 0 0 1 7.5 7.5V4a2 2 0 0 1 2-2zm5 5.5H20a2 2 0 1 1 0 4h-5.5v-4zm2 5h2A2 2 0 0 1 20.5 14.5V20a2 2 0 1 1-4 0v-7.5zm-5 2V20a2 2 0 1 1-4 0v-5.5h4zM4 7.5h2.5v4H4a2 2 0 1 1 0-4zm0 5h5.5v4H4a2 2 0 1 1 0-4z',
  ...
  meta: 'M6.915 4.03c-1.968 0-3.683 1.28-4.871 3.113C.704 9.208 0 11.883 0 14.449c0 3.14 1.25 5.521 4.439 5.521 2.65 0 3.8-2.1 6.628-6.764l.942-1.665 2.335 4.345c1.83 3.15 3.3 4.533 5.53 4.533 2.71 0 4.126-2.02 4.126-5.56 0-5.5-2.96-10.38-6.8-10.38-2.1 0-3.73 1.46-5.1 3.34-1.72-2.2-3.3-3.34-5.185-3.34zm.01 2.6c1.25 0 2.45 1.13 3.86 3.03-2.84 4.44-4.05 7.72-6.35 7.72-1.25 0-1.84-1.13-1.84-2.84 0-4.1 1.8-7.91 4.33-7.91zm10.15-.55c2.55 0 4.64 3.82 4.64 8.4 0 1.97-.6 2.9-1.84 2.9-1.18 0-2.2-1.35-5.11-6.39 1.04-1.68 1.39-2.27 2.31-3.46.67-.88 1.3-1.45 2-1.45z',
};
