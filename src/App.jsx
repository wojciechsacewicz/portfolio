...
const copy = {
  pl: {
    ...
    navContact: 'Kontakt',
    language: 'EN',
    heroKicker: 'Wojciech Sacewicz · AI Native Developer Intern',
    ...
    proofRole: 'Idego',
    proofRoleText: 'AI Native Developer Intern',
    proofTime: '40%',
    proofTimeText: 'krótsze generowanie raportów w procesie DOVISTA',
    proofStack: 'AI agents',
    proofStackText: 'codzienne kodowanie z agentami',
    proofLang: 'C1 English',
    proofLangText: 'swobodna rozmowa po polsku i angielsku',
    ...
    desireBody: 'Rozmawiamy o problemie, składam pierwszy prototyp z pomocą agentów AI, pokazuję demo i poprawiamy kierunek.',
    stepOne: 'Pomysł',
    ...
    aboutBody: 'Lubię nowe technologie, ale nie chowam się za nimi. Pytam, pokazuję działające demo i poprawiam. Tak chcę budować narzędzia, które pomagają zespołom w pracy.',
    aboutCurrentTitle: 'Teraz',
    aboutCurrentBody: 'Idego · AI Native Developer Intern · 2026',
    ...
    contactBody: 'Masz proces, narzędzie albo aplikację, które fajnie byłoby mieć? Napisz. Pomogę sprawdzić, czy da się z tego szybko zrobić działającą wersję.',
    email: 'Napisz do mnie',
    linkedin: 'LinkedIn',
    github: 'GitHub',
    workspaceTitle: 'Fun fact: mój setup',
    workspaceBody: 'Biurko, sprzęt i Windows, bo lubię mieć dobrze poukładane środowisko pracy.',
  ...
  en: {
    ...
    proofStack: 'AI agents',
    proofStackText: 'daily coding with agents',
    proofLang: 'C1 English',
    proofLangText: 'clear conversation in Polish and English',
    ...
    desireBody: 'We talk through the problem, I build the first prototype with AI agents, then we use the demo to choose the next direction.',
    stepOne: 'Idea',
    ...
    aboutBody: 'I like new technology, but I do not hide behind it. I ask questions, show a working demo, and improve it. That is how I want to build tools that help teams at work.',
    ...
    contactBody: 'Got a process, tool, or app that would be useful to have? Send it over. I can help check whether it can become a working first version fast.',
    email: 'Email me',
    linkedin: 'LinkedIn',
    github: 'GitHub',
    workspaceTitle: 'Fun fact: my setup',
    workspaceBody: 'Desk, gear, and Windows setup, because I like my work environment organized.',
...
const projects = [
  {
    ...
    meta: 'AI agents · internal tools · 2026',
    body: {
      pl: 'Aktualny staż, na którym pracuję z agentami AI i uczę się dowozić szybkie prototypy w realnym środowisku firmowym.',
      en: 'Current internship where I work with AI agents and learn to ship fast prototypes in a real company environment.',
    },
  ...
  },
  {
    ...
    meta: 'UiPath · SAP · report process',
    body: {
      pl: 'Stażowy projekt RPA. Robot pomógł skrócić generowanie raportów o 40% i ograniczyć powtarzalne przepisywanie danych.',
      en: 'RPA internship project. The robot helped shorten report generation by 40% and reduce repeated data entry.',
    },
...
const stacks = {
  pl: [
    ['AI coding', 'Codex, Claude Code, Cursor, praca z agentami'],
    ['Aplikacje', 'React, Vite, Node.js, szybkie prototypy'],
    ['Integracje', 'REST API, webhooks, MongoDB, JSON, podstawy SQL'],
    ['Proces i demo', 'rozmowa z użytkownikiem, mały zakres, działająca wersja'],
  ],
  en: [
    ['AI coding', 'Codex, Claude Code, Cursor, agent-based work'],
    ['Apps', 'React, Vite, Node.js, fast prototypes'],
    ['Integrations', 'REST APIs, webhooks, MongoDB, JSON, SQL basics'],
